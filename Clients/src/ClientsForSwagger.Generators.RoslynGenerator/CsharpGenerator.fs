namespace ClientsForSwagger.Generators.RoslynGenerator
  ...
  let generateClients (settings:GenerationSettings) (swagger:Documentation) name =
    ...
    let syntaxFactory =
      ...
      |> addUsings [
          ...
          "Newtonsoft.Json"
          settings.Namespace
          "ClientsForSwagger.RestClient.Results.DiscriminatedUnions"
          "ClientsForSwagger.RestClient.Results"
          "ClientsForSwagger.RestClient" ]
      |> addMembers ns
