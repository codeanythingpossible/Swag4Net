      ...
      testList "spec parsing tests" [
        testList "route parsing tests" [
          ...
          test "Parsing one empty path" {
            let routes = 
               ...
               }""" |> Document.fromJson |> Parser.parseRoutes loadReference
          ...
          test "Parsing POST /pet" {
            let route = 
               ...
               }""" |> Document.fromJson |> Parser.parseRoutes loadReference |> Seq.head
          ...
          testList "parameters parsing tests" [
            ...
            test "Parsing int32 path param" {
              ...
              let parameter = 
                """{
                  ...
                  "type": "integer",
                  "format": "int32"
                }""" |> parseProps |> Parser.parseParameter spec loadReference
            ...
            test "Parsing int64 data type" {
              let actual =
                ...
                |> Document.fromJson |> Parser.parseDataType spec loadReference
          ...
          test "responses parsing tests" {
            let responses =
              ...
              }""" |> Document.fromJson |> Parser.parseResponses spec loadReference
        ...
        testList "definitions parsing tests" [
          ...
          test "Parsing simple definition" {
            let actual =
              ...
              |> Document.fromJson |> Parser.parseSchemas spec loadReference |> Seq.head
            Expect.equal actual
                (Ok { Name="ApiResponse"
                      Properties=
        ...
        testList "YAML parsing tests" [
          ...
          test "parsing yaml should give same result than json" {
            ...
            let yamlSpec = Parser.parseSwagger loadReference yaml
            let jsonSpec = Parser.parseSwagger loadReference json
